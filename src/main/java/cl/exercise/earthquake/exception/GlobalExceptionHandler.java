...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  public ResponseEntity<?> handleResponseExceptions(ResourceException ex, WebRequest request)
  ...
  private ResponseEntity<?> getResponseEntity(Exception ex, WebRequest request)
    ...
    ErrorDetails error =
        ErrorDetails.builder()
            ...
            .build();
    ErrorList errors = ErrorList.builder().errors(Arrays.asList(error)).build();
